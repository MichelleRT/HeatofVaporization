...
clf = RandomForestClassifier(n_estimators=1000, oob_score=True, n_jobs=-1, class_weight="balanced")  
x = []
y = []
...
# print (cv_scores)
print "The accuracy score is: ", (metrics.accuracy_score(y, cv_scores))  
print "The precision is: ", (metrics.average_precision_score(y, cv_scores)) 
